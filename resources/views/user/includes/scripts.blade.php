...
<!-- dropzonejs -->
<script src="{{ url('storage/plugins/dropzone/min/dropzone.min.js') }}"></script>
<!-- Bootstrap 4 -->
<script src="{{ url('storage/plugins/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
<!-- Select2 -->
<script src="{{ url('storage/plugins/select2/js/select2.full.min.js') }}"></script>

<!-- jquery-validation -->
<script src="{{ url('storage/plugins/jquery-validation/jquery.validate.min.js') }}"></script>
<script src="{{ url('storage/plugins/jquery-validation/additional-methods.min.js') }}"></script>
