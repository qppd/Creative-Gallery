...
<head>
    ...
    <!-- Select2 -->
    <link rel="stylesheet" href="{{ url('storage/plugins/select2/css/select2.min.css') }}">
    <link rel="stylesheet" href="{{ url('storage/plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css') }}">
    ...
    <!-- SweetAlert2 -->
    <link rel="stylesheet" href="{{ url('storage/plugins/sweetalert2-theme-bootstrap-4/bootstrap-4.min.css') }}">
    <!-- Toastr -->
    <link rel="stylesheet" href="{{ url('storage/plugins/toastr/toastr.min.css') }}">
    <!-- BS Stepper -->
    <link rel="stylesheet" href="{{ url('storage/plugins/bs-stepper/css/bs-stepper.min.css') }}">
    <!-- dropzonejs -->
    <link rel="stylesheet" href="{{ url('storage/plugins/dropzone/min/dropzone.min.css') }}">

    <!-- JQuery Dropdown -->
    <link rel="stylesheet" type="text/css" href="{{ url('storage/dist/css/style4.css') }}">
    <script src="{{ url('storage/plugins/jquery-dropdown/modernizr.custom.63321.js') }}"></script>
